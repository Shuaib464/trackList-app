...
function Month() {
    ...
    const prevClickHandler = () => {
      ...
      // console.log('Prev-Year value -> ',prevYear)
    ...
    const nextClickHandler = () => {
      ...
      // console.log('next-Year value (next) -> ', nextYear);
      dispatch(fetchMonthByDate({
          month: nextMonth,
          year: nextYear
      }))
            ...
            <div className='w-full max-w-2xl mx-auto shadow-md rounded-lg px-4 py-3 text-white'>
              <div className='flex justify-between items-center'>
                <button onClick={prevClickHandler} 
                    className='text-lg cursor-pointer border py-1 px-2 ml-1 rounded-lg transition ease-in-out delay-75 duration-200 hover:scale-110'>
                  Previous
                </button>
